...
export const uiManager = {
    initFilters() {
        ...
        allData.forEach(d => {
            if (d['Perusahaan'] && d['Perusahaan'] !== '-') perusahaanSet.add(d['Perusahaan']);
            if (d['Departemen'] && d['Departemen'] !== '-') departemenSet.add(d['Departemen']);
            ...
            if (d['Tanggal']) {
                const dateStr = d['Tanggal'].toString();
        ...
        // Set default tahun ke tahun saat ini jika tersedia
        const currentYear = new Date().getFullYear().toString();
        if (sortedTahun.includes(currentYear)) {
            fTahun.value = currentYear;
        }
    },
    ...
    updateDepartemenByPerusahaan() {
        ...
        if (perusahaan === 'all') {
            ...
            allData.forEach(d => {
                if (d['Departemen'] && d['Departemen'] !== '-') allDepartemen.add(d['Departemen']);
            });
            ...
            allData.forEach(d => {
                if (d['Perusahaan'] === perusahaan && d['Departemen'] && d['Departemen'] !== '-') {
    ...
    updateStatistics() {
        ...
        const totalLaki = allData.filter(d => {
            const jk = d['Jenis Kelamin'] || '';
            return jk.includes('Laki') || jk.includes('Laki-laki');
        }).length;
        
        const totalPerempuan = allData.filter(d => {
            const jk = d['Jenis Kelamin'] || '';
